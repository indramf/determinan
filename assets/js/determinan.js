...
function convertToHours(value, unit) {
  ...
  function calculateOptimization() {
    ...
    if (result.success) {
        resultDiv.innerHTML = `
          Jumlah optimal produksi untuk periode ${period}:<br>
          Produk A: ${result.unitsA} unit<br>
          Produk B: ${result.unitsB} unit<br>
  ...
  function reset() {
    ...
    document.querySelectorAll(".result").forEach(element => {
      element.innerHTML = ""; // atau gunakan element.textContent = "" untuk menghapus teks saja
    });
